...
int lastValue1 = 0;         // Previous reading
...
//      filteredValue = 0.1 * (-frequency_0) + (1 - 0.1) * filteredValue;
  ...
  if (abs(-frequency_1 - lastValue1) <= 15) {
      peakDetection2.add(-frequency_1);                     // adds a new data point
      double filtered2 = peakDetection2.getFilt();   // moving average
